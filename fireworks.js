(function ($) {
    ...
    Rocket.prototype.explode = function() {
        if (options.sound && soundState) {
          soundState = false
          audio.src = 'https://img.tukuppt.com/newpreview_music/08/98/81/5c88be616d87775653.mp3';
          audio.loop = 'loop'
          audio.play();
        }
        ...
        for (var i = 0; i < count; i++) {
            ...
            var speed = Math.cos(Math.random() * Math.PI / 2) * 35;
